...
public class HarrvillagerEntity extends PathfinderMob {
	public HarrvillagerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HarrmodJavaModEntities.HARRVILLAGER.get(), world);
	}

	public HarrvillagerEntity(EntityType<HarrvillagerEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new TemptGoal(this, 1, Ingredient.of(HarrmodJavaModItems.HARRONITGEM.get()), false));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(HarrmodJavaModItems.HARRONITGEM.get()));
	}
